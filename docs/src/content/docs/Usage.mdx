...
Replace `${GITLAB_ACCESS_TOKEN}` with a Gitlab access token created from repository [Gitlab settings page](https://gitlab.s-v.de/sv/sv-frontend-library/mono/-/settings/access_tokens).
