...
<section className="flex flex-col md:flex-row items-center gap-module-4xl mb-module-8xl move-in lg:px-module-3xl">
  <div>
    <img className="light-mode-only" width="400" src={`/atrium-light.png`} />
    <img className="dark-mode-only" width="400" src={`/atrium-dark.png`} />
  </div>
...
<section className="fade-in">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1 pb-module-4xl">
    <a className="home-card" href={`/components/accordion`}>
      <a-animation
        src={`/animation/atrium_components.riv`}
        autoplay
        height={200}
        width={320}
        loop
    ...
    <a className="home-card" href={`/components/dialog`}>
      <a-animation
        src={`/animation/atrium_components.riv`}
        autoplay
        height={200}
    ...
    <a className="home-card" href={`/components/popover`}>
      <a-animation
        src={`/animation/atrium_components.riv`}
        autoplay
        height={200}
    ...
    <a className="home-card" href={`/components/carousel`}>
      <a-animation
        src={`/animation/atrium_components.riv`}
        autoplay
        height={200}
