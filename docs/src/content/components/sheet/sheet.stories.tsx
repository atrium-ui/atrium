...
import Sheet from "@components/src/vue/Sheet.vue";
      ...
      <div class="flex min-h-[400px] items-center justify-center">
        <Sheet>
          <div class="flex flex-col gap-4">
            <div class="font-medium text-lg">Sheet Content</div>
  ...
  render: () => {
    return (
      <div class="min-h-[400px] w-full bg-gray-50">
        {/* Header bar */}
        <div class="flex items-center justify-between border-gray-200 border-b bg-white px-4 py-3">
          {/* Logo skeleton */}
        ...
        <Sheet>
          <div class="flex flex-col gap-6">
            ...
            <div
              ...
              onclick="document.querySelector('#sheet').enabled = false"
            >
              <Button variant="ghost">
                <svg
                  class="h-6 w-6"
        ...
        <Sheet>
          <div class="flex flex-col gap-6">
            ...
            <div class="flex items-center justify-between">
              <span class="font-medium text-lg">Filters</span>
              <div onclick="document.querySelector('#sheet').enabled = false">
            ...
            <div class="flex flex-col gap-2">
              <span class="font-medium text-gray-700 text-sm">Price Range</span>
                  ...
                  <label key={stars} class="flex items-center gap-2">
                    ...
                    <div class="flex gap-0.5">
                      {[...Array(5)].map((_, i) => (
                        <div
                          key={i}
                          class={`h-4 w-4 rounded ${i < stars ? "bg-yellow-400" : "bg-gray-200"}`}
                        />
                      ))}
                    </div>
                  </label>
