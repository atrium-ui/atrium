...
class DraggerDebug extends Dragger {
  ...
  destroy () {
    ...
    try { this.options.container.removeChild(this.markerAnchorVertical) } catch (e) {}
    try { this.options.container.removeChild(this.markerAnchorHorizontal) } catch (e) {}
    try { this.options.container.removeChild(this.markerOffsetLeft) } catch (e) {}
    try { this.options.container.removeChild(this.markerOffsetRight) } catch (e) {}
    try { this.options.container.removeChild(this.markerOffsetTop) } catch (e) {}
    try { this.options.container.removeChild(this.markerOffsetBottom) } catch (e) {}
  }
  ...
  createMarker () {
    ...
    this.markerAnchorVertical.style.left = (this.options.center ? this.options.container.clientWidth / 2 : this.options.rtl ? this.options.container.clientWidth : 0) + 'px'
    ...
    this.markerAnchorHorizontal.style.top = (this.options.center ? this.options.container.clientHeight / 2 : 0) + 'px'
    ...
    this.markerOffsetLeft.style.left = (this.options.rtl ? this.options.offsets.right : this.options.offsets.left) + 'px'
    ...
    this.markerOffsetRight.style.right = (this.options.rtl ? this.options.offsets.left : this.options.offsets.right) + 'px'
