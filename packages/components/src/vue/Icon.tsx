...
export function Icon(props: {
  ...
  return (
    <span
      aria-hidden="true"
      class={[
        "align-sub leading-none [&>svg]:block [&>svg]:h-[1em] [&>svg]:w-[1em]",
        props.class,
      ]}
    >
...
const ICONS = {
  ...
  reload: (
    <svg viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      <title>reload</title>
      <path
        d="M13.366 0.454234C13.366 0.203367 13.1626 0 12.9118 0C12.6609 0 12.4575 0.203367 12.4575 0.454234V2.08498C11.6911 1.31811 10.7343 0.715435 9.6294 0.357041C5.92348 -0.845003 1.93415 1.14852 0.724229 4.82225C-0.486209 8.49756 1.54836 12.4475 5.25575 13.6501C8.96167 14.8521 12.951 12.8586 14.1609 9.18484L13.298 8.90066C12.2473 12.0912 8.77444 13.8363 5.53604 12.7859C2.2991 11.736 0.53684 8.2954 1.5871 5.10644C2.63789 1.9159 6.11071 0.170789 9.34911 1.22119C10.3993 1.56183 11.2938 2.15385 11.9876 2.9071H10.0047C9.75379 2.9071 9.55043 3.11046 9.55043 3.36133C9.55043 3.6122 9.75379 3.81556 10.0047 3.81556H13.366V0.454234Z"
        fill="currentColor"
      />
    </svg>
  ),
